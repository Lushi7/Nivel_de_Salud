...
# write.xlsx(F10.2021, "//10.21.11.5/4-Servicios de Salud/Monitoreo SGC/Bases/F10/F10-2022/F10.2021.xlsx", overwrite = TRUE)

# 2021
write_xlsx(F10.2021, noquote(paste(c(format(Sys.time(), "//10.21.11.5/4-Servicios de Salud/Monitoreo SGC/Bases/F10/F10-2022/F10.2021.%Y.%m.%d.xlsx"),sep ="."))))
